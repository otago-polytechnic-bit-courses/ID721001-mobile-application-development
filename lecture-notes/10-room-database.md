...
Open the `login-room-database` directory found [here](https://github.com/otago-polytechnic-bit-courses/ID721001-mobile-application-development/blob/master/lecture-notes/login-room-database.zip) in **Android Studio**.
