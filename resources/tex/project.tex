...
\begin{itemize}
	...
	\item All country data must be fetched using \textbf{Retrofit} from a \textbf{GitHub Gist}. You have been provided an example called \textbf{example.json} in the \textbf{course materials repository $>$ assessments}.
