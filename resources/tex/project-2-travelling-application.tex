...
\begin{itemize}
	...
	\item Country data needs to be fetched using \textbf{Retrofit} from a \textbf{GitHub Gist}. You have been provided an example file called \textbf{country-data.json}. 
	...
	\item Text translation support. If a country is multilingual (use of more than one language), choose one language. For example, Canada's main languages are English and French. You would choose either English or French.
		\begin{itemize}
			\item Use \textbf{Retrofit} and the \textbf{Yandex Translate API} to translate text from one language to another. To use the \textbf{Yandex Translate API}, you will need an \textbf{API key}. A key will be privately given to you on \textbf{Microsoft Teams}.
	...
	\item \textbf{Google Map} displaying top-rated tourist attractions.
	      \begin{itemize}
		      ...
		      \item The marker's information window \textbf{must} display the attraction's name and city/town.
