...
\lfoot{Project\\Version 2, Semester One, 2022}
\rfoot{\thepage}
...
In this \textbf{individual} assessment, you will develop a mobile game using your chosen game engine \& publish it to \textbf{Google Play Store}. Also, you will provide a game document that addresses many aspects of game development. In addition to the mobile game \& game document, you will conduct an evaluative conversation with your course lecturer. 
...
You will complete this assessment during your learner managed time, however, there will be availability during the weekly meetings to discuss the requirements \& your progress of this assessment. This assessment will need to be completed by \textbf{Friday, 11 November 2022} at \textbf{5 PM}.
...
\begin{itemize}
	...
	\item Application is published to \textbf{Google Play Store}.
	      ...
	      \end{itemize}
	\item Ability to download your application from \textbf{Google Play Store} on to a a variety of mobile devices.
\end{itemize}

\subsection*{Documentation - Learning Outcomes 2, 3 (30\%)}
\begin{itemize}
	\item Create a game document using the provide game document, i.e., side-scroller adventure platformer with action-based puzzles as a template.
\end{itemize}
