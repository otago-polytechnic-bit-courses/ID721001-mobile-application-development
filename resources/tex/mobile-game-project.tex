...
In this \textbf{individual} assessment, you will develop a mobile game using \textbf{Unity} \& publish it to \textbf{Google Play Store}. Also, you will provide documentation that addresses several aspects of game development. In addition to the mobile game \& documentation, you will present your mobile game and answer follow up questions related to the development process.
...
\begin{itemize}
	...
	\item The mobile game is published to \textbf{Google Play Store}.
	      \begin{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Link to the mobile game on \textbf{Google Play Store}.
...
\begin{itemize}
	\item Present your mobile via a video recording. In addition, you need to answer the following:
	\begin{itemize}
