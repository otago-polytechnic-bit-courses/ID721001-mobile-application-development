...
You have been provided a directory called \textbf{01-practical} containing 15 \textbf{Kotlin} files. In these files, write your solutions to the 15 problems below using \textbf{IntelliJ IDEA}. 
