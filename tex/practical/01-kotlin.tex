...
For this assessment, you will complete \textbf{15 coding problems} using \textbf{Kotlin} in \textbf{Repl.it}. This assessment is worth \textbf{3\%} of the final mark for \textbf{IN721: Mobile Application Development}.
