...
For this assessment, you will complete \textbf{15 coding problems} using \textbf{Kotlin} in \textbf{Repl.it}. This assessment is worth \textbf{2\%} of the final mark in \textbf{IN721: Mobile Application Development}.
