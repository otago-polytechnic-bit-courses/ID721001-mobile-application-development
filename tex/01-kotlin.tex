...
For this assessment, you will solve \textbf{15 coding problems} using \textbf{Kotlin} in \textbf{IntelliJ IDEA}. This assessment is worth \textbf{2\%} of the final mark in \textbf{IN721: Mobile Application Development}.
