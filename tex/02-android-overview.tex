...
In this assessment, you will create a \textbf{Calculator} project \& user-interface in preparation for the next assessment. This assessment is worth 1\% of the final mark in IN721: Mobile Application Development.
...
You will complete this assessment during your learner managed time, however, there will be availability during the teaching sessions to discuss the requirements \& your progress of this assessment. This assessment will need to be completed by Tuesday, 9 March 2021 at 5:00 PM. 
...
\section*{Submissions}
You must submit all program file(s) via \textbf{GitHub Classroom}. Here is the link to the repository you will use for your submission – \href{https://classroom.github.com/a/VJIq7Ae0}{https://classroom.github.com/a/VJIq7Ae0}. Create a new branch from the \textbf{main} branch called \textbf{02-android-overview}. This branch will be your development branch for this assessment. Once you have completed this assessment, create a pull request \& assign the \textbf{GitHub} user \textbf{grayson-orr} to a reviewer. Please do not merge your own pull request. Late submissions will incur a 10\% penalty per day, rolling over at 5:00 PM.
...
\begin{itemize}
	...
	\item Save location - /<YOUR GITHUB REPOSITORY>/calculator
	\item Language - Kotlin
	\item Minimum SDK - API 28: Android 9.0 (Pie)
\end{itemize}

\subsection{Task 2:} In its basic form, the action bar display the title
