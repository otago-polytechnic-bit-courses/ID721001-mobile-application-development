...
In this \textbf{individual} assessment, you will develop a mobile game using \textbf{Unity} and publish it to \textbf{Google Play Store} or \textbf{Apple App Store}. In addition to the mobile game and documentation, you will present the mobile game and answer follow up questions via a video recording.
...
\begin{tabular}{|c|c|c|c|}
	...
	Practical           & 20\%            & 10-11-2023 (Friday at 4.59 PM)  & 2, 3                    \\ \hline
...
\section*{Part 1 (60\%)}
\subsection*{Functionality - Learning Outcomes 1, 2, 3}
\begin{itemize}
...
\section*{Part 2 (20\%)}
\subsection*{Presentation - Learning Outcomes 2, 3}
\begin{itemize}
