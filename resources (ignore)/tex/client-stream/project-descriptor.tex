...
In this \textbf{individual} assessment, you will develop a mobile application for either an internal or external client using \textbf{React Native} and \textbf{Expo}, and publish it to \textbf{Google Play Store} or \textbf{Apple App Store}. Also, you will present the mobile application and answer follow up questions via a video recording. In addition, marks will be allocated for code elegance, documentation and \textbf{Git} usage.
...
\begin{tabular}{|c|c|c|c|}
	...
	Project           & 80\%            & 10-11-2023 (Friday at 4.59 PM)  & 1, 2, 3                    \\ \hline
\end{tabular}
...
\begin{itemize}
    ...
    \begin{itemize} 
	  \item Link to the mobile application on \textbf{Google Play Store} or \textbf{Apple App Store}.
