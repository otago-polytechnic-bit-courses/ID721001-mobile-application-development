...
\title{Course Directive\\ID721001: Mobile Application Development\\Semester Two, 2025}
\date{}
\maketitle
...
\section*{Aims}
To learn the specifics of mobile application design and development.
...
\begin{tabular}{|c|c|c|c|}
	...
	\small Project                 & \small 80\%        & \small Sunday 9th November at 11.59 PM) \small  & \small 1, 2 and 3                   \\ \hline
\end{tabular}
...
\begin{tabular}{|c|c|c|}
	...
	1/Tahi           & \multicolumn{2}{c|}{React Native and Expo}    \\ \hline
	2/Rua            & \multicolumn{2}{c|}{Navigation and Async Storage}                   \\ \hline
	3/Toru           & \multicolumn{2}{c|}{Scroll View and Lists} \\ \hline
	4/Whā            & \multicolumn{2}{c|}{Tailwind CSS, App Icon and Splash Screen}                               \\ \hline
	5/Rima           & \multicolumn{2}{c|}{SQLite}                                                \\ \hline
	6/Ono            & \multicolumn{2}{c|}{Firebase}                                                   \\ \hline
	7/Whitu          &  \multicolumn{2}{c|}{Location and Map}                            \\ \hline
	8/Waru           & \multicolumn{2}{c|}{Camera, Audio and Video}                                                   \\ \hline
	9/Iwa            & \multicolumn{2}{c|}{Web View and Speech}                                                                 \\ \hline
	10/Tekau         & \multicolumn{2}{c|}{Other SDKs}                                                                 \\ \hline
...
\subsection*{Appeals}
If you are concerned about any aspect of your assessment, approach the teaching staff in the first instance. We support an open-door policy and aim to resolve issues promptly. Further support is available from the \textbf{Head of Information Technology (Michael Holtz)} and \textbf{First-Year Coordinator (Elise Allen)}. \textbf{Otago Polytechnic} has a formal process for academic appeals if necessary.
